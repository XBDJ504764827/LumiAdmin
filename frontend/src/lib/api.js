...
export const api = {
  ...
  createControlInstallToken: (token, groupId, body={}) => request(`/api/community/groups/${groupId}/control/install-token`, { method: 'POST', headers: withAuth(token), body: JSON.stringify(body) }),
  controlDiscoveries: (token, groupId) => request(`/api/community/groups/${groupId}/control/discoveries`, { headers: withAuth(token) }),
  controlAgents: (token, groupId) => request(`/api/community/groups/${groupId}/control/agents`, { headers: withAuth(token) }),
  confirmControlDiscoveries: (token, groupId, body) => request(`/api/community/groups/${groupId}/control/discoveries/confirm`, { method: 'POST', headers: withAuth(token), body: JSON.stringify(body) }),
  ...
  globalBanStatus: (token) => request('/api/global-bans/status', { headers: withAuth(token) }),
  ...
  abnormalRecords: (token, params = {}) => request(`/api/abnormal-records${buildQueryString(params)}`, { headers: withAuth(token) }),
  getAbnormalRecord: (token, id) => request(`/api/abnormal-records/${id}`, { headers: withAuth(token) }),
  getAbnormalRecordReplayUrl: (token, id) => request(`/api/abnormal-records/${id}/replay-url`, { headers: withAuth(token) }),
  approveAbnormalRecord: (token, id, body = {}) => request(`/api/abnormal-records/${id}/approve`, { method: 'POST', headers: withAuth(token), body: JSON.stringify(body) }),
  rejectAbnormalRecord: (token, id, body = {}) => request(`/api/abnormal-records/${id}/reject`, { method: 'POST', headers: withAuth(token), body: JSON.stringify(body) }),
  rejectAndBanAbnormalRecord: (token, id, body = {}) => request(`/api/abnormal-records/${id}/reject-and-ban`, { method: 'POST', headers: withAuth(token), body: JSON.stringify(body) }),
  retryAbnormalRecordSubmit: (token, id) => request(`/api/abnormal-records/${id}/retry-submit`, { method: 'POST', headers: withAuth(token), body: JSON.stringify({}) }),
  abnormalRecordRules: (token, params = {}) => request(`/api/abnormal-record-rules${buildQueryString(params)}`, { headers: withAuth(token) }),
  createAbnormalRecordRule: (token, body) => request('/api/abnormal-record-rules', { method: 'POST', headers: withAuth(token), body: JSON.stringify(body) }),
  updateAbnormalRecordRule: (token, id, body) => request(`/api/abnormal-record-rules/${id}`, { method: 'PUT', headers: withAuth(token), body: JSON.stringify(body) }),
  deleteAbnormalRecordRule: (token, id) => request(`/api/abnormal-record-rules/${id}`, { method: 'DELETE', headers: withAuth(token) }),
