...
test('buildKickCommand generates correct Source engine command', () => {
  assert.equal(buildKickCommand('76561198000000000'), 'kickid "76561198000000000"');
  assert.equal(buildKickCommand('76561198000000000', '作弊'), 'kickid "76561198000000000" "作弊"');
});
